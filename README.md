...
| macOS Privilege Context | Default is **user context**, not root. This is the opposite of Windows (SYSTEM) and Linux (root). Scripts requiring root must use `sudo` explicitly. |
